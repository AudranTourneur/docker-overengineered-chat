...
<div class="flex flex-col w-full h-full mx-auto justify-center items-center m-4">
	<div class="space-y-2 text-center">
		<h1
			class="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-700 to-purple-400 glitch"
		>
			The <br /> Overengineered <br /> Chat
		</h1>
	</div>
